...
export const COMMANDS: CommandDefinition[] = [
  ...
  {
    name: "/open",
    description: "Open a resource or file (<query>)",
    scopes: ["global", "course", "workspace"],
  },
  { name: "/timeline", description: "Show timeline (week | month | semester | next N days/weeks, --all)", scopes: ["global", "course"] },
  { name: "/grade", description: "Show grades (need <letter>, <course>)", scopes: ["global", "course"] },
  { name: "/quiz", description: "Practice quiz (<count>, easy/medium/hard, flash, <topic>)", scopes: ["course", "workspace"] },
  { name: "/announcements", description: "Browse course announcements", scopes: ["global", "course"], navigation: true, noArgs: true },
  { name: "/thread", description: "Read a discussion thread (<id> | <title>)", scopes: ["global", "course"] },
  {
    name: "/lecture",
    description: "Find and open lecture content (<query>)",
  ...
  {
    name: "/clear",
    description: "Clear chat and reset context",
    scopes: ["global", "course", "workspace"],
    noArgs: true,
  },
  {
    name: "/copy",
    description: "Copy last response (all | last <N>)",
    scopes: ["global", "course", "workspace"],
  },
  ...
  {
    name: "/pdf",
    description: "Generate a PDF from chat context (<instructions>)",
    scopes: ["global", "course", "workspace"],
    aliases: ["/make-pdf"],
  },
  {
    name: "/model",
    description: "Switch AI model (effort | key)",
    scopes: ["global", "course", "workspace"],
    navigation: true,
  },
  {
